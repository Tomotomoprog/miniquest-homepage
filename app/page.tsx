...
export default function Home() {
  return (
    // mainタグを削除し、React Fragment <>...</> で全体を囲む
    <>
      {/* ========= Hero ========= */}
      <section
        className="
      ...
      >
        {/* 背景画像 */}
        <div className="absolute inset-0 bg-hero-illustration bg-cover bg-center -z-20"></div>
        {/* オーバーレイ */}
        <div className="absolute inset-0 bg-gradient-to-t from-blue-950/80 to-blue-800/60 -z-10"></div>

        <div className="max-w-7xl mx-auto w-full flex justify-end text-white z-10">
          <div className="w-full md:w-1/2 text-center md:text-right pr-4 md:pr-0">
